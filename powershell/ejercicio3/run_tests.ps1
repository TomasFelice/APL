...
# Contador de pruebas (usando ámbito global)
$global:testCount = 0
$global:passCount = 0
$global:failCount = 0
...
Write-Host "==================" -ForegroundColor Cyan
Write-Host "Total de pruebas: $global:testCount" -ForegroundColor White
Write-Host "Exitosas: $global:passCount" -ForegroundColor Green
Write-Host "Fallidas: $global:failCount" -ForegroundColor Red
